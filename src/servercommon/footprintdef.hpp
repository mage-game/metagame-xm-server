#ifndef __FOOTPRINT_DEF_HPP__
#define __FOOTPRINT_DEF_HPP__
...
typedef char FootprintParamHex[sizeof(FootprintParam) * 2 + 1];
UNSTD_STATIC_CHECK(sizeof(FootprintParamHex) < 768);
