#ifndef __SHENYI_DEF_HPP__
#define __SHENYI_DEF_HPP__
...
typedef char ShenyiParamHex[sizeof(ShenyiParam) * 2 + 1];
UNSTD_STATIC_CHECK(sizeof(ShenyiParamHex) < 512);

#endif  // __SHENYI_DEF_HPP__
