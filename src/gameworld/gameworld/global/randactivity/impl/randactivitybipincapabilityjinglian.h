#ifndef __RAND_ACTIVITY_BIPIN_CAPABILITY_WASH_HPP__
#define __RAND_ACTIVITY_BIPIN_CAPABILITY_WASH_HPP__

#include "global/randactivity/randactivity.hpp"

class RandActivityBipinCapabilityWash : public RandActivity
{
public:
	RandActivityBipinCapabilityWash(RandActivityManager *rand_activity_manager);
	virtual ~RandActivityBipinCapabilityWash();
