#ifndef __RAND_ACTIVITY_BIPIN_CAPABILITY_MOUNT_HPP__
#define __RAND_ACTIVITY_BIPIN_CAPABILITY_MOUNT_HPP__

#include "global/randactivity/randactivity.hpp"

class RandActivityBipinCapabilityMount : public RandActivity
{
public:
	RandActivityBipinCapabilityMount(RandActivityManager *rand_activity_manager);
	virtual ~RandActivityBipinCapabilityMount();
