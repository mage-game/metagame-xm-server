#ifndef __RAND_ACTIVITY_BIPIN_CAPABILITY_TOTAL_HPP__
#define __RAND_ACTIVITY_BIPIN_CAPABILITY_TOTAL_HPP__

#include "global/randactivity/randactivity.hpp"

class RandActivityBipinCapabilityTotal : public RandActivity
{
public:
	RandActivityBipinCapabilityTotal(RandActivityManager *rand_activity_manager);
	virtual ~RandActivityBipinCapabilityTotal();
	...
	virtual void RankBipinHistory(PersonRankItem Top[Protocol::TOP_COUNT]);
