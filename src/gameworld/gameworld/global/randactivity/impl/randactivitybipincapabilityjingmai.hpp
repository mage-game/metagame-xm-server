#ifndef __RAND_ACTIVITY_BIPIN_CAPABILITY_JINGMAI_HPP__
#define __RAND_ACTIVITY_BIPIN_CAPABILITY_JINGMAI_HPP__

#include "global/randactivity/randactivity.hpp"

class RandActivityBipinCapabilityJingmai : public RandActivity
{
public:
	RandActivityBipinCapabilityJingmai(RandActivityManager *rand_activity_manager);
	virtual ~RandActivityBipinCapabilityJingmai();
