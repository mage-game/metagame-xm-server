#ifndef __RAND_ACTIVITY_BIPIN_CAPABILITY_EQUIP_HPP__
#define __RAND_ACTIVITY_BIPIN_CAPABILITY_EQUIP_HPP__

#include "global/randactivity/randactivity.hpp"

class RandActivityBipinCapabilityEquip : public RandActivity
{
public:
	RandActivityBipinCapabilityEquip(RandActivityManager *rand_activity_manager);
	virtual ~RandActivityBipinCapabilityEquip();
