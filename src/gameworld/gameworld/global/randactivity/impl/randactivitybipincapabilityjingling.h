#ifndef __RAND_ACTIVITY_BIPIN_CAPABILITY_JINGLING_HPP__
#define __RAND_ACTIVITY_BIPIN_CAPABILITY_JINGLING_HPP__

#include "global/randactivity/randactivity.hpp"

class RandActivityBipinCapabilityJingling : public RandActivity
{
public:
	RandActivityBipinCapabilityJingling(RandActivityManager *rand_activity_manager);
	virtual ~RandActivityBipinCapabilityJingling();
