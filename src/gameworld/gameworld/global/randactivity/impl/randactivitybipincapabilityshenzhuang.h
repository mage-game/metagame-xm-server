#ifndef __RAND_ACTIVITY_BIPIN_CAPABILITY_SHENZHUANG_HPP__
#define __RAND_ACTIVITY_BIPIN_CAPABILITY_SHENZHUANG_HPP__

#include "global/randactivity/randactivity.hpp"

class RandActivityBipinCapabilitySZ : public RandActivity
{
public:
	RandActivityBipinCapabilitySZ(RandActivityManager *rand_activity_manager);
	virtual ~RandActivityBipinCapabilitySZ();
