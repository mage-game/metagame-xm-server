...
public:
	...
	void SendChallengeReportInfo();		// 战报信息
	void SendChallengeUserInfo();		// 玩家信息
	void OnGetOpponentDetailInfo();		// 对手信息
...
private:
	...
	CrossChallengeFieldOpponentInfo m_opponent_info_list[CHALLENGE_FIELD_OPPONENT_MAX];	// 对手uuid列表(不存储)
