#ifndef SHENGONGFUNCTION_HPP
#define SHENGONGFUNCTION_HPP

#include "protocal/msgshengong.hpp"
class Role;
class Knapsack;

class ShengongFunction
{
public:
	// 进阶
	...
	// 激活
	static bool ActiveShengong(Role *role, bool is_recal = true);

	// 特殊形象进阶
	static bool ShengongSpecialImgUpgrade(Role *role, short special_img_id);
	...
	// 升星级
	static bool UpStarLevel(Role *role,Protocol::CSShengongUpStarLevel *msg);
