...
MonsterAiCishaCamp3::MonsterAiCishaCamp3(Character *me)
: MonsterAIMoveAround(me, MonsterInitParam::AITYPE_CISHA_CAMP3)
{

}

MonsterAiCishaCamp3::~MonsterAiCishaCamp3()
{

}

void MonsterAiCishaCamp3::AI(unsigned long interval)
{
...
void MonsterAiCishaCamp3::Init(const MonsterAIParam &mp)
{
...
bool MonsterAiCishaCamp3::IsEnemy(Obj *obj)
{
	if (Obj::OBJ_TYPE_ROLE == obj->GetObjType())
	{
		Role *role = (Role*)obj;

		return role->GetCamp() != CAMP_TYPE_ZHUIYUE && role->IsAlive();
	}

	return false;
}

bool MonsterAiCishaCamp3::IsFriend(Obj *obj, bool check_alive)
{
	if (Obj::OBJ_TYPE_ROLE == obj->GetObjType())
	{
		Role *role = (Role*)obj;
		return (!check_alive || role->IsAlive()) && role->GetCamp() == CAMP_TYPE_ZHUIYUE && role->IsAlive();
	}

	return false;
}

bool MonsterAiCishaCamp3::FindEnemy()
{
...
bool MonsterAiCishaCamp3::IsAttackWhenOnAttack(ObjID attacker)
{
