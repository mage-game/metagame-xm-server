...
MonsterAiCishaCamp2::MonsterAiCishaCamp2(Character *me)
: MonsterAIMoveAround(me, MonsterInitParam::AITYPE_CISHA_CAMP2)
{

}

MonsterAiCishaCamp2::~MonsterAiCishaCamp2()
{

}

void MonsterAiCishaCamp2::AI(unsigned long interval)
{
...
void MonsterAiCishaCamp2::Init(const MonsterAIParam &mp)
{
...
bool MonsterAiCishaCamp2::IsEnemy(Obj *obj)
{
	if (Obj::OBJ_TYPE_ROLE == obj->GetObjType())
	{
		Role *role = (Role*)obj;

		return role->GetCamp() != CAMP_TYPE_ZHURI && role->IsAlive();
	}

	return false;
}

bool MonsterAiCishaCamp2::IsFriend(Obj *obj, bool check_alive)
{
	if (Obj::OBJ_TYPE_ROLE == obj->GetObjType())
	{
		Role *role = (Role*)obj;
		return (!check_alive || role->IsAlive()) && role->GetCamp() == CAMP_TYPE_ZHURI && role->IsAlive();
	}

	return false;
}

bool MonsterAiCishaCamp2::FindEnemy()
{
...
bool MonsterAiCishaCamp2::IsAttackWhenOnAttack(ObjID attacker)
{
