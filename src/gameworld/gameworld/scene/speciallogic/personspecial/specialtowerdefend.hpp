#ifndef _SPECIAL_TOWERDEFEND_HPP_
#define _SPECIAL_TOWERDEFEND_HPP_

#include "scene/speciallogic/speciallogic.hpp"
#include "other/fb/towerdefendconfig.hpp"
#include "protocal/msgfb.h"

class SpecialTowerDefend : public SpecialLogic 
{
public:
	SpecialTowerDefend(Scene *scene);
	virtual ~SpecialTowerDefend();
...
private:
	...
	bool m_new_player_leave;

	
	unsigned int m_scene_begin_time;
};
