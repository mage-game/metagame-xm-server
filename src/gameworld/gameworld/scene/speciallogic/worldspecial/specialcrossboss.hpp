#ifndef _SPECIAL_CROSS_BOSS_HPP_
#define _SPECIAL_CROSS_BOSS_HPP_
...
class SpecialCrossBoss : public SpecialLogic
{
public:
	enum ENBOSSSTATUS
	{
...
public:
	SpecialCrossBoss(Scene *scene);
	virtual ~SpecialCrossBoss();
	...
	void GetCrossBossInfo(int index, Protocol::SCCrossBossBossInfoAck::BossInfo &boss_info, short &left_treasure_crystal_count, short &left_monster);
...
protected:
	...
	CrossBossInfo m_boss_list[MAX_CROSS_BOSS_PER_SCENE];
	CrossBossMonsterInfo m_monster_list[CROSS_BOSS_MAX_MONSTER_NUM];
	CrossBossOrdinaryCrystalInfo m_ordinary_crystal_list[CROSS_BOSS_MAX_ORDINARY_CRYSTAL];
...
#endif // _SPECIAL_CROSS_BOSS_HPP_
