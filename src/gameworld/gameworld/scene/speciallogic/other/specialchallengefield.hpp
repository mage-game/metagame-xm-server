#ifndef __SPECIAL_CHALLENGE_FIELD_HPP__
#define __SPECIAL_CHALLENGE_FIELD_HPP__
...
class SpecialChallengeField : public SpecialLogic
{
public:
	SpecialChallengeField(Scene *scene);
	virtual ~SpecialChallengeField();
