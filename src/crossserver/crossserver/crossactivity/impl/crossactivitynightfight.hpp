#ifndef __CROSS_ACTIVITY_NIGHT_FIGHT_HPP__
#define __CROSS_ACTIVITY_NIGHT_FIGHT_HPP__

#include "servercommon/crossdef.hpp"
#include "crossactivity/crossactivity.hpp"
#include "servercommon/internalprotocal/crossgameprotocal.h"

class CrossActivityNightFight : public CrossActivity
{
public:
	CrossActivityNightFight(CrossActivityManager *cross_activity_manager);
	~CrossActivityNightFight();
	...
	void OnRecvNightFightRankTop(const crossgameprotocal::GameCrossnNightFightInfoSync * cgnfi);
private:
...
#endif // __CROSS_ACTIVITY_NIGHT_FIGHT_HPP__
