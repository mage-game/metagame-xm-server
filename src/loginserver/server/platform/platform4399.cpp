...
bool Platform4399::Check(NetID netid, PlatName pname, unsigned int login_time, LoginStr str, short server)
{
	...
	char str_tmp[512];
	int str_len = SNPRINTF(str_tmp, sizeof(str_tmp), "%s%u%s", pname, login_time, "nMT3GGeBGHJ2UV1P");
