...
bool PlatformYujun::Check(NetID netid, PlatName pname, unsigned int login_time, LoginStr str, short server)
{
	...
	char str_tmp[512];
	int str_len = SNPRINTF(str_tmp, sizeof(str_tmp), "%s%u%d%s", pname, login_time, "mJ5I3AdPGZHt7UV2P");
